      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">PENGGUNA TAMPIL</h1>
              </div>
            </div>
            <!-- /.row -->
          </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a class="btn-primary rounded p-2" href="tambah_pengguna.php">Tambah Data</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            while($d = mysqli_fetch_array($data)){
                              ...
                              <tr style="height:50px; text-align:center;">
                                ...
                                <td style="text-align: center;">
                                    <a class="btn-warning rounded p-2" href="edit-pengguna.php?id=<?php echo $d['id_pengguna'] ?>">EDIT</a>
                                    <a class="btn-danger rounded p-2" href="hapus-pengguna.php?id=<?php echo $d['id_pengguna'] ?>" onclick="hapusData(<?php echo $d['id_pengguna'] ?>)">HAPUS</a>
                                </td>
                              </tr>
                                <?php 
                                }
